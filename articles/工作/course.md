...
```cmd
 ...
 yarn pkg meet-circle2-question build
 lerna add lodash --scope=@ceramics-math/utils
 lerna add @ceramics-math/meet-circle2-question --scope=@ceramics-math/core
 lerna add @ceramics-ae/base --scope=@ceramics-math/remainder-division1-question 
 lerna add @ceramics-math/components --scope=@ceramics-math/meet-circle2-question
...
npm link ../k12-web/node_modules/react-dom
