...
![flex-布局详解](..\..\images\html-css\flex\flex布局.png)
...
![flex-order](..\..\images\html-css\flex\flex-order.png)
...
![flex-子容器属性](..\..\images\html-css\flex\flex-子容器属性.png)
...
![flex-父容器属性](..\..\images\html-css\flex\flex-父容器属性.png)



梳理的是常见的属性值，对于一些不常见的属性值，请[移步MDN](https://developer.mozilla.org/zh-CN/docs/Glossary/Flex)
...
3. 觉得不错的话，也可以阅读TianTian近期梳理的文章（感谢掘友的鼓励与支持🌹🌹🌹）： 
   - [「查缺补漏」我的2020前端面试秘籍，为你秋招保驾护航](https://juejin.im/post/6864398060702760968)(400+👍)
